...
!(function (t, e) {
    ...
    function rb(t, e, r) {
        ...
        if (!p) {
            if (
                ("," === t.substr(-1) && (t = t.substr(0, t.length - 1)), At[t])
            )
                p = At[t];
            else if ("#" === t.charAt(0)) {
                if (
                ...
                ? ((n = e.charAt(0)),
                  ...
                  "<" === n || ">" === n
                      ...
                      : ((n = parseFloat(e.charAt(i - 1) + e.substr(i + 1))),
                        a &&
                            r &&
                            (n = (n / 100) * (Z(r) ? r[0] : r).totalDuration()),
                        1 < i
            ...
            return (
                ...
                m !== We &&
                    ...
                    r.svg &&
                        ...
                        (r.forceCSS =
                            t.setAttribute("transform", "") || !Jd(pd(t, Qe))),
