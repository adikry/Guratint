...
(function ($) {
    ...
    if ($("body").hasClass("tt-transition")) {
        ...
        function HideLoad() {
            ...
            var $circleCustom = $(".circle-blur-custom");
            if ($circleCustom.length) {
                tl_transitOut.from(
                    $circleCustom,
                    {
                        duration: 1,
                ...
                jumpToHash = (hash) => {
                    ...
                    if (target) {
                        scrollbar.scrollIntoView(target, {
                            offsetTop:
                                parseFloat(
                                    target.getAttribute("data-offset")
                                ) || 0, // Change to set default offset
                        });
                    }
                };
    ...
    if ($(".custom-zoom").length) {
        ...
        const growTl = gsap.timeline({ defaults: { ease: "none" } });

        // Create animations for content-zoom, content1, and content3
        const contentZoomAnimation = gsap.to(".content-zoom", {
            duration: 1,
            scale: 1,
        });
        ...
        growTl
            .add(contentZoomAnimation)
            .add(content1Animation, 0) // Start content1Animation at the same time as contentZoomAnimation
            .add(content3Animation, 0); // Start content3Animation at the same time as contentZoomAnimation

        // Set up scroll trigger using the timeline
                ...
                $ttContentCarousel.find(".swiper")[0],
                {
                    ...
                    on: {
                        ...
                        transitionStart: function () {
                            ...
                            // $(".swiper-slide-active")
                            //   .find(".tt-content-carousel-item")
                            //   .each(function () {
                            //     $(this).addClass("data-tilt");
                            //   });
                        },
    ...
    if ($("#page-header").hasClass("ph-content-parallax")) {
        ...
        if ($("#page-header").hasClass("ph-bg-image")) {
            ...
            if ($(".custom-button-head").length) {
                tlPhParallax.to(".custom-button-head", { y: -100 }, 0);
            }
            if ($(".ph-meta").length) {
